...
5. Synergy with Schaeffler's Portfolio
...
**Technology Novelty for Schaeffler:** 
- [score] - [explanation]

**Current Capabilities:** 
- [list 3 specific Schaeffler technologies]

**Technology Gaps:** 
- [list 3 specific gaps]

**Development Path:** 
- [Build/Buy/Partner/Acquire - explain choice]
...
- [list 3 specific needs]

**Competitive Position:**
- [explain first-mover vs fast-follower]
